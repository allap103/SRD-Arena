"""Effect schemas supported by the capability runtime."""
...
from .requirements import AttackHitRequirementSchema, CapabilityRequirementSchema
...
ExecutableEffectSchema = Annotated[
    DamageEffectSchema
    | HealingEffectSchema
...
# Actions use the same executable vocabulary; declared non-executable additions
# live under schemas.drafts and are composed by the creature action schema.
ActionEffectSchema = ExecutableEffectSchema
